  ...
  return (
    <AuthLayout
      ...
      labels={{
        ...
        terms: 'I agree to the <a href="#">Terms of Service</a> and <a href="/privacy">Privacy Policy</a>',
        submit: "Create account",
        passwordToggle: "Toggle password visibility",
      }}
      showcase={{
        image: {
          src: "https://images.unsplash.com/photo-1522071823991-b1ae5e6a3048?q=80&w=1200&auto=format&fit=crop",
